...
export const productListReducer = (state = { products: [] }, action) => {
  switch (action.type) {
    ...
    //destructure {data} from listProduct action to properly account the value for object properties
...
export const productUpdateReducer = (state = { product: {} }, action) => {
  switch (action.type) {
    case PRODUCT_UPDATE_REQUEST:
      return { loading: true }
    //we are sending the updatedProduct object from the action but is not being called in the ProductEditScreen
